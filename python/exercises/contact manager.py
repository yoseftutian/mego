...
#         self.file = file
#
#     def adding(self, name, phone, email):
#         with open(self.file, mode="a") as file:
#             file.write(f"name:{name} ,phone:{phone} ,email:{email}\n")
#
#
# contact_manager = ContactManager("C:\\repos\\mego\\python\\exercises\\contact_list.txt")
# contact_manager.adding("John Doe", "123-456-7890", "john.doe@example.com")
# contact_manager.adding(" Doe", "123-456-7890", "john.doe@example.com")
class ContactManager:
